...
const elements = [
	{
		...
		src="https://carbon.now.sh/embed?bg=rgba%281%2C22%2C39%2C1%29&t=night-owl&wt=none&l=htmlmixed&width=680&ds=true&dsyoff=20px&dsblur=48px&wc=true&wa=true&pv=30px&ph=39px&ln=false&fl=1&fm=Hack&fs=14px&lh=133%25&si=false&es=2x&wm=false&code=%253Cform%2520class%253D%2522input-form%2520flex-column%2520flex-gap-1%2520flex-grow-1%2520flex-wrap%2522%253E%250A%2520%2520%2520%2520%253Csection%2520class%253D%2522input-container%2520flex-column%2522%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%253Cinput%2520id%253D%2522email%2522%2520class%253D%2522textbox-content%2522%2520type%253D%2522email%2522%2520name%253D%2522email%2522%2520aria-label%253D%2522Enter%2520Email%2522%2520%252F%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%253Clabel%2520for%253D%2522email%2522%2520class%253D%2522textbox-label%2522%253EEmail%253Cspan%2520class%253D%2522required-field%2522%253E*%253C%252Fspan%253E%253C%252Flabel%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%253Cspan%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%253Csub%2520class%253D%2522email-check%2522%253E%253C%252Fsub%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%253C%252Fspan%253E%250A%2520%2520%2520%2520%253C%252Fsection%253E%250A%2520%2520%2520%2520%253Csection%2520class%253D%2522input-container%2520flex-column%2522%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%253Cinput%2520id%253D%2522password%2522%2520class%253D%2522textbox-content%2522%2520type%253D%2522password%2522%2520name%253D%2522password%2522%2520aria-label%253D%2522Enter%2520Password%2522%2520%252F%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%253Ci%2520class%253D%2522fas%2520fa-eye%2520show-password%2522%2520id%253D%2522show-password%2522%2520aria-label%253D%2522Show%2520password%2520button%2522%253E%253C%252Fi%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%253Clabel%2520for%253D%2522password%2522%2520class%253D%2522textbox-label%2522%253EPassword%253Cspan%2520class%253D%2522required-field%2522%253E*%253C%252Fspan%253E%253C%252Flabel%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%253Cspan%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%253Csub%2520class%253D%2522password-check%2522%253E%253C%252Fsub%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%253C%252Fspan%253E%250A%2520%2520%2520%2520%253C%252Fsection%253E%250A%253C%252Fform%253E"
	...
	},
	{
		...
		elementCodeInnerText: `<iframe
		src="https://carbon.now.sh/embed?bg=rgba%281%2C22%2C39%2C1%29&t=night-owl&wt=none&l=htmlmixed&width=680&ds=true&dsyoff=20px&dsblur=48px&wc=true&wa=true&pv=30px&ph=39px&ln=false&fl=1&fm=Hack&fs=14px&lh=133%25&si=false&es=2x&wm=false&code=%253Cdiv%2520class%253D%2522form-container%2520flex-colmn%2520flex-gap-2%2522%253E%250A%2520%2520%2520%2520%253Csection%2520class%253D%2522form-header%2520flex-row%2520align-center%2520justify-content-space-between%2522%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%253Ch3%2520class%253D%2522form-heading%2520text-bold%2522%253EFilters%253C%252Fh3%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%253Ca%2520href%253D%2522%2523%2522%2520class%253D%2522link-btn%2522%253EClear%2520All%253C%252Fa%253E%250A%2520%2520%2520%2520%253C%252Fsection%253E%250A%2520%2520%2520%2520%253Cul%2520class%253D%2522radio-btn-container%2522%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%253Cli%2520class%253D%2522no-list%2520form-heading%2520text-bold%2522%253ESort%2520by%253C%252Fli%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%253Cli%2520class%253D%2522no-list%2522%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%253Cinput%2520class%253D%2522radio-btn%2522%2520type%253D%2522radio%2522%2520id%253D%2522radio-btn%2522%2520name%253D%2522radio-btn%2522%2520value%253D%2522Price%2520Low%2520to%2520High%2522%250A%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520aria-label%253D%2522Sort%2520by%2520price%253A%2520low%2520to%2520high%2522%2520%252F%253E%2520Price%253A%250A%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520Low%2520to%2520High%250A%2520%2520%2520%2520%2520%2520%2520%2520%253C%252Fli%253E%250A%2520%2520%2520%2520%253C%252Ful%253E%250A%2520%2520%2520%2520%253Cul%2520class%253D%2522checkbox-btn-container%2522%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%253Cli%2520class%253D%2522no-list%2520form-heading%2520text-bold%2522%253ECategories%253C%252Fli%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%253Cli%2520class%253D%2522no-list%2522%253E%253Cinput%2520class%253D%2522checkbox-btn%2522%2520type%253D%2522checkbox%2522%2520value%253D%2522Casual%2520Shoes%2522%250A%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520aria-label%253D%2522Filter%2520to%2520casual%2520shoes%2522%2520%252F%253E%2520Casual%2520Shoes%253C%252Fli%253E%250A%2520%2520%2520%2520%253C%252Ful%253E%250A%253C%252Fdiv%253E"
		class="rui-code--iframe" scrolling="yes"
		sandbox="allow-scripts allow-same-origin">
	  	</iframe>`,
		elementJSCodeClassPath:
	...
	},
	{
		...
		elementCodeInnerText: `<iframe
		src="https://carbon.now.sh/embed?bg=rgba%281%2C22%2C39%2C1%29&t=night-owl&wt=none&l=htmlmixed&width=680&ds=true&dsyoff=20px&dsblur=48px&wc=true&wa=true&pv=30px&ph=39px&ln=false&fl=1&fm=Hack&fs=14px&lh=133%25&si=false&es=2x&wm=false&code=%253Cform%2520class%253D%2522input-form%2520flex-column%2520flex-gap-1%2520flex-grow-1%2520flex-wrap%2522%253E%250A%2520%2520%2520%2520%253Csection%2520class%253D%2522input-container%2520input-with-icon%2520flex-column%2522%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%253Cinput%2520id%253D%2522search%2522%2520class%253D%2522textbox-content%2522%2520type%253D%2522text%2522%2520name%253D%2522search%2522%2520placeholder%253D%2522Search...%2522%250A%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520aria-label%253D%2522Search%2520Products%2520here%2522%2520%252F%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%253Ci%2520class%253D%2522fas%2520fa-search%2520search-icon%2522%253E%253C%252Fi%253E%250A%2520%2520%2520%2520%253C%252Fsection%253E%250A%253C%252Fform%253E"
		class="rui-code--iframe" scrolling="yes"
		sandbox="allow-scripts allow-same-origin">
	  	</iframe>`,
		elementJSCodeClassPath:
