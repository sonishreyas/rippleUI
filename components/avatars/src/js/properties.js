...
const elements = [
	{
		...
		elementCodeInnerText: `<iframe
			src="https://carbon.now.sh/embed?bg=rgba%2823%2C24%2C26%2C1%29&t=seti&wt=none&l=htmlmixed&width=680&ds=true&dsyoff=20px&dsblur=68px&wc=true&wa=true&pv=36px&ph=35px&ln=false&fl=1&fm=Hack&fs=14px&lh=133%25&si=false&es=2x&wm=false&code=%253Carticle%2520class%253D%2522avatar-container%2520flex-row%2520%250Ajustify-content-center%2520align-center%2520flex-gap-1%2522%253E%250A%2520%2520%2520%2520%253Cp%2520class%253D%2522avatar%2520b-radius-circle%2520avatar-text%250A%2520flex-row%2520justify-content-center%2520align-center%2520xl%2522%253ESS%253C%252Fp%253E%250A%2520%2520%2520%2520%253Cp%2520class%253D%2522avatar%2520b-radius-circle%2520avatar-text%250A%2520flex-row%2520justify-content-center%2520align-center%2520l%2522%253ESS%253C%252Fp%253E%250A%2520%2520%2520%2520%253Cp%2520class%253D%2522avatar%2520b-radius-circle%2520avatar-text%250A%2520flex-row%2520justify-content-center%2520align-center%2520m%2522%253ESS%253C%252Fp%253E%250A%2520%2520%2520%2520%253Cp%2520class%253D%2522avatar%2520b-radius-circle%2520avatar-text%250A%2520flex-row%2520justify-content-center%2520align-center%2520s%2522%253ESS%253C%252Fp%253E%250A%253C%252Farticle%253E"
			class="rui-code--iframe" scrolling="yes"
			sandbox="allow-scripts allow-same-origin">
	  	</iframe>`,
		elementJSCodeBtnClassPath:
			".text-avatar .rui-import-html .rui-code-tabs--container .rui-code-js-btn",
		...
		sandboxURL: "https://codesandbox.io/s/avatar-2zoxu",
	},
	{
		name: "Profile Avatar",
		rootCodeTabFilePath: "../../../../main/html/code-tabs-root.html",
		...
		elementCodeInnerText: `<iframe
			src="https://carbon.now.sh/embed?bg=rgba%2823%2C24%2C26%2C1%29&t=seti&wt=none&l=htmlmixed&width=680&ds=true&dsyoff=20px&dsblur=68px&wc=true&wa=true&pv=36px&ph=35px&ln=false&fl=1&fm=Hack&fs=14px&lh=133%25&si=false&es=2x&wm=false&code=%253Carticle%2520class%253D%2522avatar-container%2520flex-row%2520%250Ajustify-content-center%2520align-center%2520flex-gap-1%2522%253E%250A%2520%2520%2520%2520%253Cimg%2520src%253D%2522https%253A%252F%252Fraw.githubusercontent.com%252F%250Asonishreyas%252FrippleUI%252Fdev%252Fcomponents%252Fmedia%252Fimages%252Fprofile.jpeg%2522%250A%2520%2520%2520%2520%2520%2520%2520%2520alt%253D%2522User%2520Profile%2520Picture%2522%2520class%253D%2522avatar%2520%250Ab-radius-circle%2520xl%2522%2520aria-label%253D%2522User%2520Profile%2520Avatar%2522%2520%252F%253E%250A%2520%2520%2520%2520%253Cimg%2520src%253D%2522https%253A%252F%252Fraw.githubusercontent.com%252F%250Asonishreyas%252FrippleUI%252Fdev%252Fcomponents%252Fmedia%252Fimages%252Fprofile.jpeg%2522%250A%2520%2520%2520%2520%2520%2520%2520%2520alt%253D%2522User%2520Profile%2520Picture%2522%2520class%253D%2522avatar%250A%2520b-radius-circle%2520l%2522%2520aria-label%253D%2522User%2520Profile%2520Avatar%2522%2520%252F%253E%250A%2520%2520%2520%2520%253Cimg%2520src%253D%2522https%253A%252F%252Fraw.githubusercontent.com%252F%250Asonishreyas%252FrippleUI%252Fdev%252Fcomponents%252Fmedia%252Fimages%252Fprofile.jpeg%2522%250A%2520%2520%2520%2520%2520%2520%2520%2520alt%253D%2522User%2520Profile%2520Picture%2522%2520class%253D%2522avatar%2520%250Ab-radius-circle%2520m%2522%2520aria-label%253D%2522User%2520Profile%2520Avatar%2522%2520%252F%253E%250A%2520%2520%2520%2520%253Cimg%2520src%253D%2522https%253A%252F%252Fraw.githubusercontent.com%252F%250Asonishreyas%252FrippleUI%252Fdev%252Fcomponents%252Fmedia%252Fimages%252Fprofile.jpeg%2522%250A%2520%2520%2520%2520%2520%2520%2520%2520alt%253D%2522User%2520Profile%2520Picture%2522%2520class%253D%2522avatar%2520%250Ab-radius-circle%2520s%2522%2520aria-label%253D%2522User%2520Profile%2520Avatar%2522%2520%252F%253E%250A%253C%252Farticle%253E"
			class="rui-code--iframe" scrolling="yes"
			sandbox="allow-scripts allow-same-origin">
		</iframe>`,
		elementJSCodeBtnClassPath:
			".profile-avatar .rui-import-html .rui-code-tabs--container .rui-code-js-btn",
		elementJSCodeClassPath:
	...
	},
	{
		...
		elementCodeInnerText: `<iframe
			src="https://carbon.now.sh/embed?bg=rgba%2823%2C24%2C26%2C1%29&t=seti&wt=none&l=htmlmixed&width=680&ds=true&dsyoff=20px&dsblur=68px&wc=true&wa=true&pv=36px&ph=35px&ln=false&fl=1&fm=Hack&fs=14px&lh=133%25&si=false&es=2x&wm=false&code=%253Carticle%2520class%253D%2522avatar-container%2520flex-row%2520%250Ajustify-content-center%2520align-center%2520flex-gap-1%2522%253E%250A%2520%2520%2520%2520%253Carticle%2520class%253D%2522avatar-badge-container%2522%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%253Carticle%2520class%253D%2522avatar-media--container%2522%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%253Cimg%2520src%253D%2522https%253A%252F%252Fraw.githubusercontent.com%252F%250Asonishreyas%252FrippleUI%252Fdev%252Fcomponents%252Fmedia%252Fimages%252Fprofile.jpeg%2522%250A%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520alt%253D%2522User%2520Profile%2520Picture%2522%2520class%253D%2522avatar%2520%250Ab-radius-circle%2520xl%2522%2520aria-label%253D%2522User%2520Profile%2520Avatar%2522%2520%252F%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%253C%252Farticle%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%253Cp%2520class%253D%2522avatar-badge%2520b-radius-circle%2520%250Aavatar-badge-xl%2520online%2522%253E%253C%252Fp%253E%250A%2520%2520%2520%2520%253C%252Farticle%253E%250A%2520%2520%2520%2520%253Carticle%2520class%253D%2522avatar-badge-container%2522%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%253Carticle%2520class%253D%2522avatar-media--container%2522%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%253Cimg%2520src%253D%2522https%253A%252F%252Fraw.githubusercontent.com%252F%250Asonishreyas%252FrippleUI%252Fdev%252Fcomponents%252Fmedia%252Fimages%252Fprofile.jpeg%2522%250A%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520alt%253D%2522User%2520Profile%2520Picture%2522%2520%250Aclass%253D%2522avatar%2520b-radius-circle%2520l%2522%2520aria-label%253D%2522User%2520Profile%2520Avatar%2522%2520%252F%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%253C%252Farticle%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%253Cp%2520class%253D%2522avatar-badge%2520%250Ab-radius-circle%2520avatar-badge-l%2520online%2522%253E%253C%252Fp%253E%250A%2520%2520%2520%2520%253C%252Farticle%253E%250A%2520%2520%2520%2520%253Carticle%2520class%253D%2522avatar-badge-container%2522%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%253Carticle%2520class%253D%2522avatar-media--container%2522%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%253Cimg%2520src%253D%2522https%253A%252F%252Fraw.githubusercontent.com%252F%250Asonishreyas%252FrippleUI%252Fdev%252Fcomponents%252Fmedia%252Fimages%252Fprofile.jpeg%2522%250A%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520alt%253D%2522User%2520Profile%2520Picture%2522%250A%2520class%253D%2522avatar%2520b-radius-circle%2520m%2522%2520aria-label%253D%2522User%2520Profile%2520Avatar%2522%2520%252F%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%253C%252Farticle%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%253Cp%2520class%253D%2522avatar-badge%250A%2520b-radius-circle%2520avatar-badge-m%2520away%2522%253E%253C%252Fp%253E%250A%2520%2520%2520%2520%253C%252Farticle%253E%250A%2520%2520%2520%2520%253Carticle%2520class%253D%2522avatar-badge-container%2522%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%253Carticle%2520class%253D%2522avatar-media--container%2522%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%253Cimg%2520src%253D%2522https%253A%252F%252Fraw.githubusercontent.com%252F%250Asonishreyas%252FrippleUI%252Fdev%252Fcomponents%252Fmedia%252Fimages%252Fprofile.jpeg%2522%250A%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520%2520alt%253D%2522User%2520Profile%2520Picture%2522%2520%250Aclass%253D%2522avatar%2520b-radius-circle%2520s%2522%2520aria-label%253D%2522User%2520Profile%2520Avatar%2522%2520%252F%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%253C%252Farticle%253E%250A%2520%2520%2520%2520%2520%2520%2520%2520%253Cp%2520class%253D%2522avatar-badge%2520b-radius-circle%2520avatar-badge-s%2520busy%2522%253E%253C%252Fp%253E%250A%2520%2520%2520%2520%253C%252Farticle%253E%250A%253C%252Farticle%253E"
			class="rui-code--iframe" scrolling="yes"
			sandbox="allow-scripts allow-same-origin">
	  	</iframe>`,
		elementJSCodeBtnClassPath:
			".status-avatar .rui-import-html .rui-code-tabs--container .rui-code-js-btn",
		elementJSCodeClassPath:
