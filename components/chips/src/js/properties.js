...
const elements = [
	...
	},
	{
		...
		elementCodeInnerText: `<iframe
			src="https://carbon.now.sh/embed?bg=rgba%2823%2C24%2C26%2C1%29&t=seti&wt=none&l=htmlmixed&width=680&ds=true&dsyoff=20px&dsblur=68px&wc=true&wa=true&pv=36px&ph=35px&ln=false&fl=1&fm=Hack&fs=14px&lh=133%25&si=false&es=2x&wm=false&code=%253Cdiv%2520class%253D%2522chip-container%2520%250Ainput-chip--container%2520%250Ainput-chip-with-icon--container%2520%2520%250Aflex-row%2520flex-wrap%2520flex-gap-1%2522%253E%250A%2520%2520%2520%2520%253Cinput%2520type%253D%2522text%2522%2520class%253D%2522input-chip--input%2522%2520%250Aplaceholder%253D%2522Add%2520here%2522%250A%2520aria-label%253D%2522Add%2520chips%2520content%2520here%2522%2520%252F%253E%250A%253C%252Fdiv%253E"
			class="rui-code--iframe" scrolling="yes"
			sandbox="allow-scripts allow-same-origin">
	  	</iframe>`,
		elementJSCodeClassPath:
	...
	},
	{
		...
		elementCodeInnerText: `<iframe
			src="https://carbon.now.sh/embed?bg=rgba%2823%2C24%2C26%2C1%29&t=seti&wt=none&l=htmlmixed&width=680&ds=true&dsyoff=20px&dsblur=68px&wc=true&wa=true&pv=36px&ph=35px&ln=false&fl=1&fm=Hack&fs=14px&lh=133%25&si=false&es=2x&wm=false&code=%253Cdiv%2520class%253D%2522chip-container%250A%2520input-chip-with-icon--container%2520%250A%2520flex-row%2520flex-wrap%2520flex-gap-1%2522%253E%250A%2520%2520%2520%2520%253Cinput%2520type%253D%2522text%2522%2520class%253D%2522input-chip--input%2520%250Ainput-icon-chip--input%2522%2520%250Aplaceholder%253D%2522Add%2520here%2522%250A%2520%2520%2520%2520%2520%2520%2520%2520aria-label%253D%2522Add%2520chips%2520content%2520here%2522%2520%252F%253E%250A%253C%252Fdiv%253E"
			class="rui-code--iframe" scrolling="yes"
			sandbox="allow-scripts allow-same-origin">
	  	</iframe>`,
		elementJSCodeClassPath:
